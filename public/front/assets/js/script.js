   ...
   let dropdowns = document.querySelectorAll('.dropdown-toggle')
        ...
        function cashdicount(cashdiscountSelector, priceSelector, countSelector, allPriceSelector, cashAllSelector, lastPriceSelector) {
            ...
            let cashDis = 0;
            let last = 0;
            if(cashdiscount && price && count && allPrice && cashAll && lastPrice) {
        ...
        function lastcart(totalPricesSelector, totalSelector, cartcashdicountSelector, cashtotalpricesSelector, lastpricesSelector) {
            ...
            if(totalPrices && total && cartcashdicount && cashtotalprices && lastprices) {
                if(totalPrices && total && cartcashdicount, cashtotalprices, lastprices) {
                    let t = 0;
                    let cash = 0;
...
function creditCalculator(monthly_payingSel, goods__priceringSel, goods__percentSel, calcSel) {
    ...
    if(monthly_paying && goods__pricering && goods__percent && calculator) {
        if(monthly_paying && goods__pricering && goods__percent, calculator) {
...
function modalcreditcalc(creadit__modal__center__monthSel, cartdurationSel, cartelperSel, cartelpriceSel, monthlypacartSel) {
    ...
    if(creadit__modal__center__month && monthlypacart && cartduration && cartelper && cartelprice) {
...
modalcreditcalc('.creadit__modal__center__month div', '.cartduration', '.cartelper', '.cartelprice', '.monthlypacart')
