      ...
      <div class="container">
         ...
         <div  class="content__goods__wrapper">
            @foreach($newgoods as $goods)
                ...
                @endif
                <div class="content__goods__title"><a style="color: black; text-decoration: none" href="{{route('goodsab', ['slug' => $goods->slug, 'color' => $goods->color_id])}}">{{substr($goods->goods_name, 0, 15)}}</a></div>
